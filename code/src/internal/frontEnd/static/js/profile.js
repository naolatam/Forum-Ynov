...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const avatarUploadErrorModal = document.getElementById('avatar-upload-error-modal');
    const avatarUploadErrorCloseBtnModal = document.getElementById('avatar-close-error');
